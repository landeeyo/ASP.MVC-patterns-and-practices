...
namespace PassingModels.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SearchController : PassingModels.Controllers.SearchController
    {
        ...
        [NonAction]
        partial void SearchOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, PassingModels.Models.ViewModels.SearchVM model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Search(PassingModels.Models.ViewModels.SearchVM model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Search);
